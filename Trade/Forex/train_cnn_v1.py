...
input_data, output_data = get_cnn_input_output(
...
# forward-propagation
x, y, logits, y_, learning_r, drop_out = cnn(
    input_dim, output_dim, time_steps=time_steps, filter=[3, 6])
    ...
    if step % 100 == 0 or step == 1:
        ...
        if saving:
            ...
            if saving_score == current_score and saving_score > 0.05:
                saver.save(
                    sess, 'saved_models/cnn-v1-avg_score{:.3f}'.format(current_score), global_step=step)
